  ...
  return (
    <>
      <div className="hidden md:block">
        ...
        <section>
          <div className="flex p-4 px-5 border 2xl:w-[80%] 2xl:mx-auto items-center">
            <CompanyLogo />
            <SearchBarDesktop />
            <div className="flex flex-1 justify-end gap-x-4 ">
              <div className="flex items-center p-2 px-3 hover:bg-slate-50 rounded-2xl text-slate-600 font-semibold">
